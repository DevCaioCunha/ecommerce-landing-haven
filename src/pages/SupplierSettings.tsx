                  ...
                  <div className="grid gap-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Receber notificações para novos pedidos</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Notificações quando os status dos pedidos mudam</p>
                      </div>
                      <Switch defaultChecked />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Alertas quando produtos atingem estoque mínimo</p>
                      </div>
                      <Switch defaultChecked />
                    </div>
