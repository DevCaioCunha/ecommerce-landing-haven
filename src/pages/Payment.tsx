        ...
        <div className="bg-[#FFF1E6] rounded-2xl p-6 md:p-8">
          ...
          <div className="space-y-6">
            ...
            <RadioGroup value={paymentMethod} onValueChange={setPaymentMethod} className="space-y-4">
              {/* Debit Card */}
              <div className={`bg-white rounded-lg p-6 ${paymentMethod === "debit" ? "ring-2 ring-yellow-400" : ""}`}>
              ...
              {/* Credit Card */}
              <div className={`bg-white rounded-lg p-6 ${paymentMethod === "credit" ? "ring-2 ring-yellow-400" : ""}`}>
                <div className="flex items-center space-x-3">
              ...
              {/* PIX */}
              <div className={`bg-white rounded-lg p-6 ${paymentMethod === "pix" ? "ring-2 ring-yellow-400" : ""}`}>
                <div className="flex items-center space-x-3">
              ...
              {/* Boleto */}
              <div className={`bg-white rounded-lg p-6 ${paymentMethod === "boleto" ? "ring-2 ring-yellow-400" : ""}`}>
                <div className="flex items-center space-x-3">
